...
<!-- EVA-ICONS JS -->
<script src="{{asset('admin')}}/assets/iconfonts/eva.min.js"></script>
...
<script src="{{asset('admin')}}/assets/plugins/p-scroll/perfect-scrollbar.min.js"></script>
<script src="{{asset('admin')}}/assets/plugins/sidemenu/sidemenu-scroll-rtl.js"></script>
...
<!-- Switcher JS -->
<script src="{{asset('admin')}}/assets/switcher/js/switcher-rtl.js"></script>
