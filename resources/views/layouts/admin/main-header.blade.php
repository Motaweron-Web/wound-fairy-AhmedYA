    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="https://laravel.spruko.com/yoha/Sidemenu-Icon-Light-rtl/index">
                <img src="{{asset('admin')}}/assets/images/brand/logo-3.png" class="header-brand-img mobile-icon" alt="logo">
                <img src="{{asset('admin')}}/assets/images/brand/logo.png" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
            ...
            <div class="d-flex mr-auto header-right-icons header-search-icon">
                ...
                <div class="dropdown profile-1">
                    @php
                        ...
                        $photo = get_file(loggedAdmin('photo'));
                    @endphp
        ...
        <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                    <div class="message-menu">
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{asset('admin')}}/assets/images/users/1.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{asset('admin')}}/assets/images/users/12.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{asset('admin')}}/assets/images/users/4.jpg"></span>
                            <div>
                        ...
                        <a class="dropdown-item d-flex pb-3" href="#">
                            <span class="avatar avatar-md brround ml-3 align-self-center cover-image" data-image-src="{{asset('admin')}}/assets/images/users/15.jpg"></span>
                            <div>
            ...
            <div class="dropdown d-md-flex country-selector">
                <a href="#" class="d-flex nav-link icon leading-none" data-toggle="dropdown" aria-expanded="true">
                    <img src="{{asset('admin')}}/assets/images/flags/us_flag.jpg" alt="img" class="ml-2 align-self-center">
                    <div>
