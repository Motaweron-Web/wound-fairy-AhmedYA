...
<!-- FAVICON -->
<link rel="shortcut icon" type="image/x-icon" href="{{asset('uploads/fav1.png')}}" />
@livewireStyles
<!-- TITLE -->
...
<link href="{{asset('admin')}}/assets/css-rtl/dark-style.css" rel="stylesheet"/>

<!-- SIDE-MENU CSS -->
<link href="{{asset('admin')}}/assets/css-rtl/sidemenu.css" rel="stylesheet">
...
<link href="{{asset('admin')}}/assets/all.min.css" rel="stylesheet">
...
<!-- Switcher CSS -->
<link href="{{asset('admin')}}/assets/switcher/css/switcher-rtl.css" rel="stylesheet">
<link href="{{asset('admin')}}/assets/switcher/demo.css" rel="stylesheet">
<script defer src="{{asset('admin')}}/assets/all.min.js"></script>
...
@livewireScripts
<link href="{{asset('admin/assets/toastr.min.css')}}" rel="stylesheet">
@yield('css')
